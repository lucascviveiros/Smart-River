...
public class GeneralSimpleUI : MonoBehaviour {
	...
	void Start () {
		...
		/*LeanTween.value(button.gameObject, button.anchoredPosition, new Vector2(200f,0), 1f ).setOnUpdate( 
			(Vector2 val)=>{
		...
		*/
		...
		LeanTween.move(button, new Vector3(0.0f,0.0f,-50f), 1f).setDelay(.1f);
